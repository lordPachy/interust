...
```{r}
users_raw = users_raw[, c('identity_type_id', 'is_bot.y', 'creation_identity_type_id', 'user_id'):=NULL]
users_raw
```
...
```{r}
n_following = followers_clean[, .N, by = follower_login]
...
stars_per_user = merge.data.table(
  ...
  all.x = T)
stars_per_user
stars_per_user[is.na(stars_per_user)] <- 0
stars_per_user
...
reaction_per_issue
n_issue_reactions_received = reaction_per_issue[, .N, by = author_login.x]
...
```{r}
commits
n_commits = commits_clean[, .N, by = author_login]
...
```{r}
pull_requests_clean
n_pull_requests = pull_requests_clean[, .N, by = author_login]
setnames(n_pull_requests, c('author_login', 'N'), c('login', 'n_pull_requests'))
n_pull_requests
```
## Pull request reactions
```{r}
...
### Put
```{r}
n_pull_request_reactions_put = pull_request_reactions_clean[, .N, by = author_login]
setnames(n_pull_request_reactions_put, c('author_id', 'N'), c('id', 'n_pull_request_reactions_put'))
n_pull_request_reactions_put = remove_missing(n_pull_request_reactions_put)
...
n_pull_request_reactions_received = reaction_per_pull_request[, .N, by = author_login.x]
setnames(n_pull_request_reactions_received, c('author_login.x', 'N'), c('login', 'n_pull_request_reactions_received'))
n_pull_request_reactions_received = remove_missing(n_pull_request_reactions_received)
...
### Posted
```{r}
n_pull_request_comments_posted = pull_request_comments_clean[, .N, by = author_login]
setnames(n_pull_request_comments_posted, c('author_login', 'N'), c('login', 'n_pull_request_comments_posted'))
n_pull_request_comments_posted = remove_missing(n_pull_request_comments_posted)
...
n_pull_request_comments_received = comments_per_pull_request[, .N, by = author_login.x]
setnames(n_pull_request_comments_received, c('author_login.x', 'N'), c('login', 'n_pull_request_comments_received'))
n_pull_request_comments_received = remove_missing(n_pull_request_comments_received)
...
### Put
```{r}
n_pull_request_comment_reactions_put = pull_request_comment_reactions_clean[, .N, by = author_login]
setnames(n_pull_request_comment_reactions_put, c('author_login', 'N'), c('login', 'n_pull_request_comment_reactions_put'))
n_pull_request_comment_reactions_put = remove_missing(n_pull_request_comment_reactions_put)
...
n_pull_request_comment_reactions_received = comment_reactions_per_pull_request[, .N, by = author_login.x]
setnames(n_pull_request_comment_reactions_received, c('author_login.x', 'N'), c('login', 'n_pull_request_comment_reactions_received'))
n_pull_request_comment_reactions_received = remove_missing(n_pull_request_comment_reactions_received)
...
### Watching
```{r}
n_repo_watched_per_user = watchers_clean[, .N, by = login]
setnames(n_repo_watched_per_user, c('login', 'N'), c('login', 'n_repo_watched_per_user'))
n_repo_watched_per_user = remove_missing(n_repo_watched_per_user)
...
users_with_scores[is.na(n_reactions_put), n_reactions_put := 0]
...
```{r}
lm = lm(formula = n_followers ~ 
          n_following
        + n_stars_put + n_stars_received 
        + n_issues_posted 
        + n_reactions_put + n_issue_reactions_received 
        + n_issue_comments_posted + n_issue_comments_received
        + n_issue_comment_reactions_put + n_issue_comment_reactions_received  
        + n_commit_comments_posted + n_commit_comments_received 
        + n_commit_comment_reactions_put + n_commit_comment_reactions_received 
        + n_pull_requests 
        + n_pull_request_reactions_put + n_pull_request_reactions_received 
        + n_pull_request_comments_posted + n_pull_request_comments_received 
        + n_pull_request_comment_reactions_put + n_pull_request_comment_reactions_received 
        + n_being_watched_from + n_repo_watched_per_user,
        data = users_with_scores)
summary(lm)
```
```{r}
lm = lm(formula = n_commits ~ n_being_watched_from, data = users_with_scores)
summary(lm)
```
```{r}
ggplot(users_with_scores, aes(n_followers, n_commits)) + geom_point()+ scale_y_continuous(trans = 'log10') + scale_x_continuous(trans = 'log10')
```
